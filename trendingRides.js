...
exports.handler = (event, context, callback) => {
    ...
    pool.getConnection(function (err, connection) {
        ...
        // Use the connection
        connection.query('SELECT * FROM prod.Rides INNER JOIN Users ON Rides.driver_id=Users.user_id ORDER BY traction DESC LIMIT ' + num, function (error, results, fields) {
